...
public class CompetitionTunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(DrivetrainConstants.steerkP)
        .withKI(DrivetrainConstants.steerkI)
        .withKD(DrivetrainConstants.steerkD)
        .withKS(DrivetrainConstants.steerkS)
        .withKV(DrivetrainConstants.steerkV)
        .withKA(DrivetrainConstants.steerkA)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);

    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(DrivetrainConstants.drivekP)
        .withKI(DrivetrainConstants.drivekI)
        .withKD(DrivetrainConstants.drivekD)
        .withKS(DrivetrainConstants.drivekS)
        .withKV(DrivetrainConstants.drivekV)
        .withKA(DrivetrainConstants.drivekA);
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.19580078125);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.368408203125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.000732421875);
    ...
    public static CTRESwerveDrivetrainConstants instantateConstants() {
        return new CTRESwerveDrivetrainConstants(kDrivetrainConstants, FrontLeft, FrontRight, BackLeft, BackRight);
    }
