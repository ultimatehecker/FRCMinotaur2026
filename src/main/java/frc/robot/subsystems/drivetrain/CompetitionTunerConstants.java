...
public class CompetitionTunerConstants {
    ...
    public static final CANBus kCANBus = new CANBus("rio", "./logs/example.hoot"); // TODO: Switch to CANivore when that comes in
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(0.036865234375);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.38623046875);
