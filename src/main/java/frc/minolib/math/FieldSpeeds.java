...
public class FieldSpeeds {
     ...
     */
    public FieldSpeeds(final double vxMetersPerSecond, final double vyMetersPerSecond, final double omegaRadiansPerSecond) {
    ...
    public String toString() {
        return "FieldSpeeds(" + vxMetersPerSecond + ", " + vyMetersPerSecond + ", " + omegaRadiansPerSecond + ")";
    }
}